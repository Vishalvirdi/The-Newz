...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    if (query == "India") {
      ...
      url =
          "https://newsapi.org/v2/everything?q=apple&from=2022-04-23&to=2022-04-23&sortBy=popularity&apiKey=119257a66bea491488cea30aa44cde56";
      ...
      url =
          "https://newsapi.org/v2/top-headlines?category=health&apiKey=119257a66bea491488cea30aa44cde56";
      ...
      url =
          "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=119257a66bea491488cea30aa44cde56";
    } else {
      url =
